...
namespace KoolVeganBlog.Migrations
{
    ...
    [Migration("20190927105443_changedTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoolVeganBlog.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KoolVeganBlog.Models.PostTag", b =>
                {
                    b.Property<int>("PostId");
            ...
            modelBuilder.Entity("KoolVeganBlog.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("KoolVeganBlog.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
